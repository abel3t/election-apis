...
CREATE TABLE "Election" (
    ...
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
    "status" "EnumElectionStatus" NOT NULL,
...
-- AddForeignKey
ALTER TABLE "Code" ADD CONSTRAINT "Code_candidateId_fkey" FOREIGN KEY ("candidateId") REFERENCES "Candidate"("id") ON DELETE CASCADE ON UPDATE CASCADE;
